            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                <input 
                  ...
                  className="p-2.5 bg-stone-900 border border-stone-800 rounded-2xl text-xs text-stone-300 placeholder:text-stone-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 w-full sm:w-60 font-medium"
                />
                <select 
                  value={filtroProvinciaMun} 
                  onChange={(e) => setFiltroProvinciaMun(e.target.value)}
                  className="p-2.5 bg-stone-900 border border-stone-800 rounded-2xl text-xs text-stone-300 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 font-medium"
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full p-2.5 bg-stone-950 border border-stone-800 rounded-xl text-xs text-stone-300 placeholder:text-stone-500 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none font-medium"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select 
                        ...
                        className="w-full p-2.5 bg-stone-950 border border-stone-800 rounded-xl text-xs text-stone-300 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none font-medium"
                      >
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input 
                        ...
                        className="p-2.5 bg-stone-950 border border-stone-800 rounded-xl text-xs text-stone-300 placeholder:text-stone-500 flex-1 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none font-medium"
                      />
                      <button 
                        type="button" 
                            ...
                            {nuevoFronton.tiene_sensor_iot && (
                              <div>
                                ...
                                <input
                                  ...
                                  className="w-full p-2.5 bg-stone-950 border border-stone-800 rounded-xl text-xs font-mono text-stone-300 placeholder:text-stone-500 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none font-medium"
                                />
                              </div>
                            )}
                          </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                <input 
                  ...
                  className="p-2.5 bg-stone-900 border border-stone-800 rounded-2xl text-xs text-stone-300 placeholder:text-stone-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 w-full sm:w-72 font-medium"
                />
                <select 
            ...
            <div className="bg-stone-900 rounded-3xl p-6 max-w-2xl w-full space-y-4 border border-stone-800 shadow-2xl">
              ...
              <div className="flex items-center gap-3">
                ...
                <input 
                  ...
                  className="p-1.5 bg-stone-950 border border-stone-800 rounded-xl text-xs text-stone-300"
                />
              </div>
