...
import IncidentStatusChangeModal from '@/components/admin/IncidentStatusChangeModal'
import AdminIncidentHistoryModal from '@/components/admin/AdminIncidentHistoryModal'
import { 
  parseSafeDate, 
  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950 flex flex-col selection:bg-emerald-100 dark:selection:bg-emerald-900 selection:text-emerald-900 dark:selection:text-emerald-100 transition-colors">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-8 space-y-6">
        ...
        <IncidentStatusChangeModal
          incidencia={incidenciaCambioEstadoModal}
          nuevoEstado={nuevoEstadoSeleccionado}
          setNuevoEstado={setNuevoEstadoSeleccionado}
          comentario={comentarioCambioEstado}
          setComentario={setComentarioCambioEstado}
          guardando={guardandoCambioEstado}
          onSubmit={handleGuardarCambioEstadoConComentario}
          onClose={() => setIncidenciaCambioEstadoModal(null)}
          t={t}
        />

        {/* MODAL VER HISTÓRICO DE INCIDENCIA */}
        <AdminIncidentHistoryModal
          incidencia={incidenciaVerHistoricoModal}
          onClose={() => setIncidenciaVerHistoricoModal(null)}
          onOpenStatusChange={(inc) => abrirModalCambioEstado(inc)}
          lang={lang}
          t={t}
        />
      </main>
